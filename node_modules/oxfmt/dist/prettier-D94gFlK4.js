...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-9wmPxzlF.js"));
	try {
...
var estreePlugin = createParsersAndPrinters([{
	importPlugin: () => import("./estree-Bq_ViZ6c.js"),
...
var { parsers, printers } = createParsersAndPrinters([
	{
		importPlugin: () => import("./acorn-Bhqm8ew7.js"),
		parsers: ["acorn", "espree"]
	},
	{
		importPlugin: () => import("./angular-DV1l9Zhh.js"),
		parsers: [
			"__ng_action",
			"__ng_binding",
			"__ng_interpolation",
	...
	{
		importPlugin: () => import("./babel-DUxzMJOC.js"),
		parsers: [
			"babel",
			"babel-flow",
			"babel-ts",
	...
	{
		importPlugin: () => import("./flow-BBddPECx.js"),
		parsers: ["flow"]
	},
	{
		importPlugin: () => import("./glimmer-CaC6S6IV.js"),
		parsers: ["glimmer"],
		printers: ["glimmer"]
	},
	{
		importPlugin: () => import("./graphql-DLdd3udx.js"),
		parsers: ["graphql"],
		printers: ["graphql"]
	},
	{
		importPlugin: () => import("./html-k9ACv7o7.js"),
		parsers: [
			"html",
			"angular",
			"vue",
	...
	{
		importPlugin: () => import("./markdown-ir78_RbM.js"),
		parsers: [
			"markdown",
			"mdx",
			"remark"
	...
	{
		importPlugin: () => import("./meriyah-B9FNK7uW.js"),
		parsers: ["meriyah"]
	},
	{
		importPlugin: () => import("./postcss-3YJi8Xcf.js"),
		parsers: [
			"css",
			"less",
			"scss"
	...
	{
		importPlugin: () => import("./typescript-Bq7RNeoo.js"),
		parsers: ["typescript"]
	},
	{
		importPlugin: () => import("./yaml-9wmPxzlF.js"),
		parsers: ["yaml"],
		printers: ["yaml"]
	}
]);

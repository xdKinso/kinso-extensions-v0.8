...
function requireNative() {
	if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) try {
		...
		try {
			...
			if (bindingPackageVersion !== "0.17.0" && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0") throw new Error(`Native binding package version mismatch, expected 0.17.0 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`);
			return binding;
		} catch (e) {
			loadErrors.push(e);
		}
...
* */
async function setupConfig(configJSON) {
...
async function formatEmbeddedCode(tagName, code) {
	...
	if (!prettierCache) prettierCache = await import("./prettier-D94gFlK4.js");
...
//#endregion
export { format as i, formatFile as n, setupConfig as r, formatEmbeddedCode as t };
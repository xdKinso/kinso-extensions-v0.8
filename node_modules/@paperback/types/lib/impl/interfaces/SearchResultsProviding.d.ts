...
export interface SearchResultsProviding extends MangaProviding {
    ...
    getSearchResults(query: SearchQuery, metadata: unknown | undefined, sortingOption: SortingOption | undefined): Promise<PagedResults<SearchResultItem>>;
    getSortingOptions?(query: SearchQuery): Promise<SortingOption[]>;
}
export declare function implementsSearchResultsProviding(extension: MangaProviding): extension is SearchResultsProviding;
//# sourceMappingURL=SearchResultsProviding.d.ts.map
...
export class CookieStorageInterceptor extends PaperbackInterceptor {
    ...
    cookiesForUrl(urlString) {
        ...
        for (const cookie of cookies) {
            ...
            if (splitHostname.length < splitCookieDomain.length ||
            ...
            for (let i = 0; i < splitCookieDomain.length; i++) {
                ...
                if (splitCookieDomain[splitCookieIndex] !=
            ...
            else if (pathname.startsWith(cookiePath) &&
 ...
 */
//# sourceMappingURL=CookieStorageInterceptor.js.map